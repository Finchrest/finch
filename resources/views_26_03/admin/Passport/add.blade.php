			...
			<div class="row">
                  <div class="col-md-12">
                     <div class="form-group ">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Enter {{ $module }}  Name" >
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group ">
                        <label>Passport Id<sup class="text-danger">*</sup></label>
                        <input type="text" name="passport_id" class="form-control" value="{{$passportId}}" placeholder="Passport Id" readonly>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group ">
                        ...
                        <div class="input-group">
                              <input type="text" name="per_day_use" class="form-control allowno" placeholder="Enter Per Day Use">
				  ...
				  <div class="col-md-4">
                     <div class="form-group ">
                        ...
                        <input type="text" id="sub_total" name="sub_total" class="form-control allowno" placeholder="Enter Subtotal" value="" oninput="setPrice(this,'sub_total','tax'); return false;" >
                     </div>
				</div> 
				  <div class="col-md-4">
                     <div class="form-group ">
						...
						<div class="input-group">
							  <input type="text" id="tax" name="tax" class="form-control allowno" placeholder="Enter Price" value="" oninput="setPrice(this,'sub_total','tax'); return false;">
							  <span class="input-group-addon " id="basic-addon3">%</span>
						</div>
					</div>
                     ...
                     <div class="form-group ">
                        ...
                        <input type="text" name="price" class="form-control allowno" placeholder="Enter Price" value="" readonly id="totalPrice">
                     </div>
                  </div> 
                  <div class="col-md-6">
                     <div class="form-group ">
                        <label>Volume<sup class="text-danger">*</sup></label>
                        <input type="text" name="volume" class="form-control allowno" placeholder="Enter Volume" value="">
                     </div>
                  </div> 
                  <div class="col-md-6">
                     <div class="form-group ">
                  ...
                  <div class="form-group">
                     ...
                     <textarea class="form-control" name="sub_description" rows="3" placeholder="Enter {{ $module }} Description" maxlength="200"></textarea>
                  </div>
               </div>
               <div class="col-md-12">
                  <div class="form-group">
                     <label>Places Description<sup class="text-danger">*</sup></label>
                     <textarea id="summernote" class="form-control" name="description" rows="3" placeholder="Enter {{ $module }} Description"></textarea>
                  </div>
               </div>
               <div class="col-md-12">
