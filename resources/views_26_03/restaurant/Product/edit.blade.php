       ...
       <div class="modal-body py-3">
            ...
            <?php $attributes = json_decode($attributes, true); 
                  ...
                  foreach($attributes['data'] as $attr) { ?>
                        <option value="<?php echo $attr['id'];?>" data-options="<?php echo $attr['options'];?>" data-option_ids="<?php echo $attr['option_ids'];?>" <?php echo ($attr_id == $attr['id'] ? 'selected' : '');?>><?php echo $attr['name'];?></option>
            <?php } ?>
            </select> 
                  ...
                  <div class="row price_row <?php echo ($is_product_attr == 1 ? 'd-none' : '');?>" >
				<div class="col-md-4">
                     <div class="form-group ">
               ...
               <div class="col-md-12 paid">
                  ...
                  $ahops=array();
                   ...
                   foreach($hops as $hop) { ?>
                        <option value="{{ $hop->id }}" <?php if(in_array($hop->id,$ahops)){echo 'selected';}?>>{{ $hop->name }}</option>
						<?php } ?>
						</select> 
                  ...
                  foreach($malts as $malt) { ?>
                        <option value="{{ $malt->id }}" <?php if(in_array($malt->id,$amalts)){echo 'selected';}?> >{{ $malt->name }}</option>
						<?php } ?>
						</select> 
                     </div>
                  </div>
               ...
               <div class="col-md-12">
                  <div class="form-group">
                     ...
                     <textarea id="" class="form-control" name="description" rows="3" placeholder="Enter Product Description" rows="10">{{ $info->description }}</textarea>
                  </div>
               </div>
			   ...
			   <div class="col-md-12 drink">
                  <div class="form-group">
                     ...
                     <textarea class="form-control" name="style"  placeholder="Enter Style:Beleiat wit" maxlength="200">{{ $info->style }}</textarea>
                  </div>
               </div>
 ...
 function form_submit(e)
   ...
   function get_setLocation(e){
      ...
      $.ajax({  
         ...
         method:"POST",  
         dataType:"json",  
         data:{type:'edit',location_id:location,place_id:place},
            success: function(data){ 
               if(data.status==1){
                  $('.select_place').html('');
   ...
   function get_setSubCategory(){
      ...
      $.ajax({  
         ...
         method:"POST",  
         dataType:"json",  
         data:{type:'edit',category_id:categoryId,sub_category_id:subCatId},
            success: function(data){ 
               if(data.status==1){
