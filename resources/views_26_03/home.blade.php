...
<!--**********|| Location Section ||**********-->
                  ...
                  <div class="fbBestPlacer w-100 clearfix">
                    <div class="PrimePlacesImg PrimePlacesOwlImg w-100 owl-carousel owl-theme">
                      @foreach($images as $img)
                        <a href="{{url('information_details/'.$place->id)}}">
    ...
    <section class="w-100 clearfix SeeWhatOther py-5 position-relative" id="SeeWhatOther">
        ...
        <div class="fbBeerPassport w-100">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <img src="{{ asset('front-assets/images/passport.jpeg') }}" data-original="{{ asset('front-assets/images/passport.jpeg') }}" class="img-fluid lazy" alt="No Image">
              </div>
            </div>
          </div>
        </div>
