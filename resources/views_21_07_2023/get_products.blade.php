...
<div class="drinks">
  <?php if ($place == 7) { ?>
    <h5 class="showOnDrink offerCode d-none">Buy 2 Get 1 FREE</h5>
  <?php } ?>
          ...
          <div class="row">
            ...
            <div class="col-md-2 col-3">
              <div class="OdrPriceDetails w-100 text-right">
                ...
                // For mumbai location only
                if ($product->location == 2) { ?>
...
@endif
@if($type == 2)
<div class="meals fbOrderMeals w-100">
  <?php if ($place == 7) { ?>
  ...
  <div class="row m-0">
    ...
    $pimg = asset($product->FileId->file);
    @endphp
    <div class="col-xl-6 px-xl-5 product-box productListBox" id="product_{{$product->id}}">
      <a href="javascript:void(0);" class="d-block">
          ...
          <div class="row">
                ...
                <div class="col-md-7 col-8">
                  <div class="OdrMiddleText w-100 HideInMob">
                    <div class="d-flex">
                      ...
                      <span><?php
                            $image = $product->is_veg == 0 ? 'is_veg/veg.png' : 'is_veg/nonveg.png'
                            ?>
                        <img src="{{ asset($image) }}" height="20px" class="mt-2 ml-2" alt="NO Image">
                      </span>
                    </div>
            ...
            <div class="col-md-2 col-3">
              <div class="OdrPriceDetails w-100 text-right">
                ...
                <div class="AddMoreBtn" style="<?php if (isset($cart[$product->id])) {
                                                  echo 'display:none;';
                                                } ?>" id="addBtn_{{$product->id}}">
                  ...
                  <?php } else { ?>
                    <p href="javascript:void(0);" class="btn m-0 onOrder onOrder2 outOfStock" id="vproductBtn_{{$product->id}}">Out of stock</p>
                  <?php } ?>
                ...
                <div class="QuntityCount pt-2 text-center" id="QuntityCount_{{$product->id}}" style="<?php if (!isset($cart[$product->id])) {
                                                                                                        echo 'display:none;';
                                                                                                      } ?>">
                  <div class="MngeQuntity">
                    <input type="hidden" name="id" value="{{$product->id}}">
