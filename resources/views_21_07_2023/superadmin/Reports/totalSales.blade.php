...
<div class="page-header card">
  <div class="card-block">
    <form method="post" action="/superadmin/reports/sales-report/export/" id="custom_filter">
...
<script>
  $(document).ready(function() {
    ...
    window.dataTable = $('#dataTable').DataTable({
      ...
      'ajax': {
        ...
        'url': "{{ route('superadmin.reports.totalSalesList') }}",
        'data': function(data) {
          data.customDate = $('#selectDate').val();;
          data.orderStatus = $('#selectStatus').val();
  ...
  function export_report() {
    ...
    $.ajax({
      ...
      url: '{{ route("superadmin.reports.totalSalesListExport") }}',
      method: "POST",
      dataType: "json",
      data: form_data,
      success: function(data) {
