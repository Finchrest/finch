			...
			<div class="row">
                  <div class="col-md-12">
                     <div class="form-group ">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Enter Hop name" value="{{ $info->name }}">
                     </div>
                  </div>

                  <div class="col-md-6">
                     <div class="form-group ">
                        <label>Discount Code<sup class="text-danger">*</sup></label>
                         <input type="text" name="discount_code" class="form-control " placeholder="Discount Code" value="{{ $info->discount_code }}">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group ">
                        ...
                        <div class="input-group">
                              <input type="text" name="discount" class="form-control allowno" placeholder="Discount" value="{{ $info->discount }}">
