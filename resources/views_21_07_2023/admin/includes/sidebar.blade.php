<nav class="pcoded-navbar">
  ...
  <div class="pcoded-inner-navbar main-menu">
    ...
    <ul class="pcoded-item pcoded-left-item">
      ...
      <li class="{{ (Route::currentRouteName() == 'admin.public-notification')? 'active': '' }}">
        <a href="{{ route('admin.public-notification') }}">
          <span class="pcoded-micon"><i class="ti-home"></i><b>D</b></span>
          <span class="pcoded-mtext">Public Notification</span>
          <span class="pcoded-mcaret"></span>
        </a>
      </li>
      ...
      <li class="pcoded-hasmenu {{ (Route::currentRouteName() == 'admin.passports' || Route::currentRouteName() == 'admin.passport_pages')? 'pcoded-trigger': '' }}">
        ...
        <ul class="pcoded-submenu">
          ...
          <li class="{{ (Route::currentRouteName() == 'admin.passport_confirm')? 'active': '' }}">
            <a href="{{ route('admin.passport_confirm') }}">
              <span class="pcoded-micon"><i class="ti-user"></i><b>H</b></span>
