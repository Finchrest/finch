  ...
  <div class="container-fluid">
    <nav class="navbar navbar-expand-md fbBeerNav" style="justify-content: space-between;">
      ...
      <ul class="navbar-nav d-mob-block" style="align-items: center;">
        ...
        <li class="nav-item pr-2"  style="font-size: 20px;" title="Passport">
        <a href="javascript:void(0);" onclick="showOrderTypePage(this); return false;"><i class="fa fa-keyboard-o text-white" style="font-size: 20px;" aria-hidden="true"></i></a>
        </li>
        ...
        <li class="nav-item pr-2" title="Passport">
