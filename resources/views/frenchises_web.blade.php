        ...
        <section class="section2 py-4" id="secondSection">
          <div class="aboutSection">
            <div class="aboutHeading mb-5">
              <h3 class="head3">About Finch Brew Cafe</h3>
            </div>
            <div class="row">
              <div class="col-lg-6">
                <div class="aboutSection_left">
                  <h5 class="head5" style="text-indent: 0;">Welcoming Environment for Socializing!</h5>
                  <p class="para">The Finch Brew Cafe is a distinctive destination, an amalgamation of international cuisine along with crafted beers & drinks.</p>
