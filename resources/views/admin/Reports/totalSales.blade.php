...
<div class="page-header card">
  ...
  <form method="post" action="/admin/reports/sales-report/export/" id="custom_filter">
          ...
          'processing': true,
           ...
           'ajax': {
             'headers': {
              ...
              'url': "{{ route('admin.reports.totalSalesList') }}",
              'data': function(data){
    ...
    var form_data = form.serialize();
     ...
     $.ajax({
       headers: {
        ...
        url: '{{ route("admin.reports.totalSalesListExport") }}',
        method: "POST",
        dataType: "json",
        data: form_data,
        success: function(data) {
