...
<div class="page-body allReportPage">
  <div class="row">
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 card-col">
      <a class="card-link report-view-btn ajax_load_url" href="{{ route('admin.reports.totalSalesReports') }}">
        <div class="card">
          <div class="card-body">
    ...
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 card-col">
      <a class="card-link report-view-btn ajax_load_url" href="{{ route('admin.reports.totalOrderReports') }}">
        <div class="card">
          <div class="card-body">
            <div class="d-flex rowFlex">
              <div class="cardIcon">
    ...
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 card-col">
      <a class="card-link report-view-btn ajax_load_url" href="{{ route('admin.reports.topProductsReports') }}">
        <div class="card">
          <div class="card-body">
            <div class="d-flex rowFlex">
              <div class="cardIcon">
    ...
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 card-col">
      <a class="card-link report-view-btn ajax_load_url" href="{{ route('admin.reports.totalAvrageOrderReports') }}">
        <div class="card">
          <div class="card-body">
            <div class="d-flex rowFlex">
              <div class="cardIcon">
    ...
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 card-col">
      <a class="card-link report-view-btn ajax_load_url" href="{{ route('admin.reports.totalRejectedReports') }}">
        <div class="card">
          <div class="card-body">
            <div class="d-flex rowFlex">
              <div class="cardIcon">
    ...
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 card-col">
      <a class="card-link report-view-btn ajax_load_url" href="{{ route('admin.reports.repeatCustomersReports') }}">
        <div class="card">
          <div class="card-body">
            <div class="d-flex rowFlex">
              <div class="cardIcon">
    ...
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 card-col">
      <a class="card-link report-view-btn ajax_load_url" href="{{ route('admin.reports.abandonedOrderReports') }}">
        <div class="card">
          <div class="card-body">
            <div class="d-flex rowFlex">
              <div class="cardIcon">
