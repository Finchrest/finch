    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" name="email" class="form-control" placeholder="Enter Email" value="{{ $info->email }}">
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" name="slogan_1" class="form-control" value="{{ $info->slogan_1 }}" placeholder="Slogan 1">
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          <label>Slogan 2</label>
          <input type="text" name="slogan_2" class="form-control" value="{{ $info->slogan_2 }}" placeholder="Slogan 2">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" name="phone_1" class="form-control" value="{{ $info->phone_1 }}" placeholder="Contact Number 1">
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          <label>Contact Number 2</label>
          <input type="text" name="phone_2" class="form-control" value="{{ $info->phone_2 }}" placeholder="Contact Number 2">
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="form-group mb-0">
          <label>Logo <small>(jpg, png, jpeg)</small><sup class="text-danger">*</sup></label>
          <div class="input-group ">
            <div class="col-md-6">
              <div class="custom-file">
                <input type="hidden" name="logo_path" value="upload/places/">
                <input type="hidden" name="logo_name" value="logo">
                <input type="file" class="custom-file" name="logo" onchange="upload_image($(form),'{{ $route->upload_logo }}','logo','file_id_logo')" accept=".jpg,.jpeg,.png">
                <input type="hidden" name="file_id_logo" id="file_id_logo" value="{{ $info->file_id_logo }}">
                <i class="logo_loader fa-btn-loader fa fa-refresh fa-spin fa-1x fa-fw" style="display:none;"></i>
              </div>
            </div>
            <div class="col-md-6">
              <?php if ($info->file_id_logo) { ?>
                <img src="{{  asset($info->LogoId->file) }}" id="logo_prev" class="img-thumbnail " alt="" width="100" height="100">
              <?php } else { ?>
                <img src="" id="logo_prev" class="img-thumbnail " alt="" width="100" height="100" style="display:none">
              <?php } ?>
            </div>
          </div>
        </div>
