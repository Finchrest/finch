  ...
  <div class="modal-body py-3">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-xl-4">
        <div class="form-group">
          <?php $pincode = explode(',', $info->allow_pincode);  ?>
          <label>Allow Pincodes<sup class="text-danger">*</sup></label>
          <input type="text" name="allow_pincode[]" class="form-control" value="<?= $info->allow_pincode ?>" data-role="tagsinput" placeholder="Add tags">
        </div>
      </div>
          ...
          <div class="input-group ">
            <div class="col-md-6">
              <div class="custom-file">
                <input type="hidden" name="image_path" value="upload/locations/">
