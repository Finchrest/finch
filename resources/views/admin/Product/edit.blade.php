...
<form action="{{ $route->store }}" onsubmit="form_submit(this);return false;" method="POST">
   ...
   <div class="modal-body py-3">
      ...
      <div class="row">
         ...
         <div class="col-md-12 d-none">
            <div class="form-group ">
               ...
               <select name="for_passport" class="form-control select_stock" onchange="getOptionValue(this)">
                  <option value="">Select</option>
                  <option value="1" <?php echo ($info->for_passport == '1' ? 'selected' : ''); ?>>Yes</option>
                  <option value="0" <?php echo ($info->for_passport == '0' ? 'selected' : ''); ?>>No</option>
               </select>
            </div>
         </div>
      </div>
      <div class="row freeProductValue  <?php if($info->for_passport == 1){ echo 'd-none';} ?>">
         <div class="col-md-12">
            <div class="form-group ">
      ...
      <div id="show_product_attr" class="col-md-12 freeProductValue  <?php if($info->for_passport == 1){ echo 'd-none';} ?>">
         <?php
         //var_dump($meta);die;
      ...
      <div class="row price_row <?php echo ($info->is_product_attr == 1 ? 'd-none' : ''); ?> freeProductValue  <?php if($info->for_passport == 1){ echo 'd-none';} ?>">
         <div class="col-md-4">
            <div class="form-group ">
         ...
         <div class="col-md-4 freeProductValue <?php if($info->for_passport == 1){ echo 'd-none';} ?>">
            <div class="form-group ">
      ...
      <div class="row">
         ...
         <div class="col-md-12 paid freeProductValue <?php if($info->for_passport == 1){ echo 'd-none';} ?>">
            <div class="form-group select2_base">
         ...
         <div class="col-md-12 drink freeProductValue  <?php if($info->for_passport == 1){ echo 'd-none';} ?>">
            <div class="form-group  ">
               <label>Hops</label>
         ...
         <div class="col-md-12 freeProductValue  <?php if($info->for_passport == 1){ echo 'd-none';} ?>">
            <div class="form-group ">
               <label>Stock</label>
         ...
         <div class="col-md-6 drink freeProductValue  <?php if($info->for_passport == 1){ echo 'd-none';} ?>">
            <div class="form-group">
