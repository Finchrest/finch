   ...
   <div class="modal-body py-3">
    ...
    <select name="for_passport" class="form-control select_stock" onchange="getOptionValue(this)">
      ...
      if (is_array($attributes['data']) && !empty($attributes['data'])) { ?>
         <div class="row freeProductValue">
            <div class="col-md-12">
               <div class="form-group ">
                  ...
                  <input type="hidden" name="is_product_attr" id="is_product_attr" value="0">
               </div>
            </div>
      ...
      <?php } ?>
      <div class="row price_row freeProductValue">
         <div class="col-md-4">
            <div class="form-group ">
         ...
         <div class="col-md-4 freeProductValue">
            <div class="form-group ">
      ...
      <div class="row">
         ...
         <div class="col-md-12 paid freeProductValue">
            <div class="form-group select2_base ">
         ...
         <div class="col-md-12 drink freeProductValue">
            <div class="form-group  ">
               <label>Hops</label>
         ...
         <div class="col-md-12 freeProductValue">
            <div class="form-group ">
               <label>Stock</label>
         ...
         <div class="col-md-6 drink freeProductValue">
            <div class="form-group">
