               ...
               <div class="card">
                  <div class="card-header p-2">
                     <ul class="nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link " href="#FreeProduct" data-toggle="tab">Free Product</a></li>
                     </ul>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                     <div class="tab-content">
                        ...
                        <div class="tab-pane " id="FreeProduct">
                           <!-- Personal Info -->
                           <div class="YOurHistory myOrderTables">
                              <div class="table-responsive" id="checkoutData">
                                 <table class="table table-border TableThree table-borderless checkout-table">
                                    <?php if ($orders->toArray()) {  ?>
                                       ...
                                       <tbody>
                                          <?php
                                          $i = 1;
                                           foreach ($productsFrees as $productsFree) { ?>
                                             <tr id="aid_{{ @$address_es['id'] }}">
                                                <td>{{ $i}}</td>
                                                <td>{{ $productsFree['passport_code'] }}</td>
                                                <td>{{ $productsFree['name'] }}</td>
                                                <td>{{ $productsFree['title'] }}</td>
                                                <td>{{ $productsFree['passport_id'] }}</td>   
                                             </tr>
