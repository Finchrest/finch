...
<html lang="en">
<head>
  <title>Finch Brew Beers</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="../front-assets/css/bootstrap.css">
  <link rel="stylesheet" href="../front-assets/css/frenchises.css">
 <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
  
  <!-- <script src="http://brew_beers.local.com/front-assets/js/jquery.slim.min.js"></script>
  <script src="http://brew_beers.local.com/front-assets/js/popper.min.js"></script>
  <script src="http://brew_beers.local.com/front-assets/js/bootstrap.bundle.min.js"></script> -->
</head>
<body>
     <div class="container">
       <div class="BrewcafeParent">
        <section class="section1" id="firstSection">
           <div class="brewcafe_logo">
               <div class="logoImg">
                  <img src="../front-assets/images/frenchises/logo.png">
               </div>
               ...
               <div class="row">
                ...
                <div class="col-lg-7">
                  <div class="aboutSection_left">
                    ...
                    <h5 class="head5">Welcoming Environment for Socializing!</h5>
                ...
                <div class="col-lg-5 mt-5 mt-lg-0">
                    <div class="aboutSection_right">
                     <div class="right_imig">
                        <img src="../front-assets/images/frenchises/img1.jpg">
                     </div>
                     ...
                     <div class="row px-2">
                        <div class="col-lg-4 col-sm-6 px-2">
                            <div class="offeringBox">
                                <div class="offeringBoximg">
                                    <img src="../front-assets/images/frenchises/img2.jpg">
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6 px-2">
                            <div class="offeringBoximg mt-3 mt-sm-0">
                                <div class="offeringBoximg">
                                    <img src="../front-assets/images/frenchises/img3.jpg">
                                </div>
                                <div class="offeringBoxText">
                        ...
                        <div class="col-lg-4 col-sm-6 px-2">
                            <div class="offeringBoximg mt-3 mt-lg-0">
                                <div class="offeringBoximg">
                                    <img src="../front-assets/images/frenchises/img4.jpg">
                                </div>
                                <div class="offeringBoxText">
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-md-5 mt-5 mt-md-0">
                            <div class="secondImgbox">
                               <img src="../front-assets/images/frenchises/img5.jpg">
                            </div>
                            
                        </div>
                        <div class="col-md-4 mt-5 mt-md-0">
                            <div class="thirdTextbox text-center">
        ...
        <section class="section7" id="sevenSection">
               <div class="contactSection">
                    <div class="contactUs">
                       ...
                       <div class="emailid">
                          <a href="javascript:void" class="text-decoration-none">
                            <span><i class="fa fa-envelope-o" aria-hidden="true"></i></sapn>
                              <span class="ml-3">info@finchbrewcafe.com </span>
                          </a>
                       </div>
                       <div class="emailid">
                        <a href="javascript:void" class="text-decoration-none">
                          <span><i class="fa fa-globe" aria-hidden="true"></i></sapn>
                            <span class="ml-3">www.finchbrewcafe.com </span>
                        </a>
                     </div>
                    </div>
               </div>
