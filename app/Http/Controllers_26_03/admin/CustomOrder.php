...
class CustomOrder extends Controller
{
    ...
    public function __construct(){
        ...
        $this->route->list = route('admin.customorders.list');
        $this->route->add = route('customorder.create');
        $this->route->store = route('customorder.store');
        $this->route->show = route("customorder.show", ":id");
    }
