        ...
        if(!$order){
            ...
            if($type == 2 || $type == 3){
                ...
                if($total > $remaining_amount){
                     ...
                     $passport_amount = 0;
                     $used_amount = $used_amount+$remaining_amount;
                     $passport_pay = $remaining_amount;
                     $remaining_amount = $passport_amount;
                    ...
                    $passport_pay = $total;
                    $used_amount = $used_amount+$total;
                    $remaining_amount = $passport_amount;
                     
                }
                // echo '<pre>'; print_r($passportOrder->toArray()); die;
