...
class HopsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module = 'Hop';
        $this->route->list = route('superadmin.hops.list');
        $this->route->add = route('hopsData.create');
        $this->route->store = route('hopsData.store');
        $this->route->edit = route("hopsData.edit", ":id");
        $this->route->destroy = route("hopsData.destroy", ":id");
    }
