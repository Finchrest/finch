...
class MaltsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module = 'Malt';
        $this->route->list = route('superadmin.malts.list');
        $this->route->add = route('maltsData.create');
        $this->route->store = route('maltsData.store');
        $this->route->edit = route("maltsData.edit", ":id");
        $this->route->destroy = route("maltsData.destroy", ":id");
    }
