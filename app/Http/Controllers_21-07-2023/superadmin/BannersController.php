...
class BannersController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module = 'Banner';
        $this->route->list = route('superadmin.banners.list');
        $this->route->add = route('bannersdata.create');
        $this->route->store = route('bannersdata.store');
        $this->route->edit = route("bannersdata.edit", ":id");
        $this->route->destroy = route("bannersdata.destroy", ":id");
