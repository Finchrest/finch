...
class PassportPagesController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->route->list = route('superadmin.passport_pages.list');
        $this->route->add = route('passport_pagesData.create');
        $this->route->store = route('passport_pagesData.store');
        $this->route->edit = route("passport_pagesData.edit", ":id");
        $this->route->destroy = route("passport_pagesData.destroy", ":id");
    }
