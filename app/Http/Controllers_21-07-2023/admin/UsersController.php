...
class UsersController extends Controller
{
    ...
    public function profileView($id)
    {
        ...
        return view('admin.' . $this->module . '.view', ['route' => $this->route, 'page' => $this->page, 'module' => $this->module, 'user' => $user, 'orders' => $orders, 'PassportOrder' => $PassportOrder, 'Address' => $address]);
    }
