...
class SubCategoriesController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->route->list = route('superadmin.sub_categories.list');
        $this->route->add = route('sub_categoriesData.create');
        $this->route->store = route('sub_categoriesData.store');
        $this->route->edit = route("sub_categoriesData.edit", ":id");
        $this->route->destroy = route("sub_categoriesData.destroy", ":id");
    }
    ...
    public function list(Request $request)
    {
        ...
        $qry->select('sub_categories.*', 'categories.name as names');
        $qry->leftJoin('categories', 'categories.id', '=', 'sub_categories.category_id');
        if ($searchValue) {
            $qry->where(function ($query) use ($searchValue) {
                $query->where('sub_categories.name', 'like', '%' . $searchValue . '%')
    ...
    public function create()
    {
        ...
        return view('superadmin.' . $this->module . '.add', ['route' => $this->route, 'module' => $this->module, 'categories' => $categories]);
    }
