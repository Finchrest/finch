...
class OffersController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module = 'Offer';
        $this->route->list = route('superadmin.offers.list');
        $this->route->add = route('offersData.create');
        $this->route->store = route('offersData.store');
        $this->route->edit = route("offersData.edit", ":id");
        $this->route->destroy = route("offersData.destroy", ":id");
