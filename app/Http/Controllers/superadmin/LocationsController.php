...
class LocationsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->route->list = route('superadmin.locations.list');
        $this->route->add = route('locationsData.create');
        $this->route->store = route('locationsData.store');
        $this->route->edit = route("locationsData.edit", ":id");
        $this->route->destroy = route("locationsData.destroy", ":id");
