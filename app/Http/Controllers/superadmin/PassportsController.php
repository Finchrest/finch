...
class PassportsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->route->list = route('superadmin.passports.list');
        $this->route->add = route('passportsData.create');
        $this->route->store = route('passportsData.store');
        $this->route->edit = route("passportsData.edit", ":id");
        $this->route->destroy = route("passportsData.destroy", ":id");
    ...
    public function create()
    {
        ...
        return view('superadmin.' . $this->module . '.add', ['route' => $this->route, 'module' => $this->module, 'locations' => $locations, 'passportId' => $passportId]);
    }
    ...
    public function edit($id)
    {
        ...
        $file_view = view('superadmin.multi_image.index', ['files' => $files, 'route' => $this->route])->render();;
        $locations = Location::get();
