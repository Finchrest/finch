...
class RestaurantsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->route->list = route('superadmin.restaurants.list');
        $this->route->add = route('restaurantsData.create');
        $this->route->store = route('restaurantsData.store');
        $this->route->edit = route("restaurantsData.edit", ":id");
        $this->route->destroy = route("restaurantsData.destroy", ":id");
