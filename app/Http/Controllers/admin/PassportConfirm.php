...
class PassportConfirm extends Controller
{
  ...
  public function __construct()
  {
    ...
    // $this->route->list = route('admin.passport-confirm-list.list');
    // $this->route->add = route('orders.create');
    // $this->route->show = route("orders.show", ":id");
    // $this->route->orderStatus = route("admin.passport-confirm.orderStatus", ":id");
    // $this->route->changeStatus = route("admin.passport-confirm.changeStatus");
    // $this->route->changeItemStatus = route("admin.passport-confirm.changeItemStatus");
  ...
  {
    $info = $this->modal::find($id);
    return view('admin.' . $this->module . '.orderStatus', [
      'info' => $info,
      'route' => $this->route,
      'module' => $this->module
    ]);
  ...
  public function refund_orders()
  {
    ...
    return view('admin.' . $this->refund_module . '.index', ['page' => $this->page, 'route' => $this->route, 'module' => $this->refund_module]);
  }
