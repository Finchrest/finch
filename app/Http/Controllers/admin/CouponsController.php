...
class CouponsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module = 'Coupon';
        $this->route->list = route('admin.coupons.list');
        $this->route->add = route('coupons.create');
        $this->route->store = route('coupons.store');
        $this->route->edit = route("coupons.edit", ":id");
        $this->route->destroy = route("coupons.destroy", ":id");
        $this->route->status = route('admin.coupons.status');
    }
