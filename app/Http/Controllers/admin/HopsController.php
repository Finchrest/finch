...
class HopsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->modal = 'App\Models\Hop';
        $this->route = new \stdClass;
        $this->module = 'Hop';
        $this->route->list = route('admin.hops.list');
        $this->route->add = route('hops.create');
        $this->route->store = route('hops.store');
        $this->route->edit = route("hops.edit", ":id");
        $this->route->destroy = route("hops.destroy", ":id");
        $this->route->status = route('admin.hops.status');
    }
